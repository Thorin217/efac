...
namespace Exactum\Efac\Http\Resources\External\Token\CRE\Dependencies;

use Illuminate\Http\Resources\Json\JsonResource;

class EmisorCREResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'codigoMH' => $this->resource->salePoint->subsidiary->goes_id,
            'codigo' => $this->resource->salePoint->subsidiary->code,
            'puntoVentaMH' => $this->resource->salePoint->goes_id,
            'puntoVenta' => $this->resource->salePoint->code,
        ];
    }
}
