...
namespace Exactum\Efac\Jobs\External\NR;

use Exactum\Efac\Enums\JsonSchemaFileNameEnum;
use Exactum\Efac\Http\Resources\External\Token\NRE\MainNREResource;
...
class MakeNRJsonTokenJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $objectForToken = json_encode(MainNREResource::make($this->dte));
