            ...
            <tr>
                <td class="table-45">
                    <table class="table-100 indentification-info">
                        <thead>
                            <tr>
                                <td colspan="2" class="back-celest general-info">Agente de
                                    Retención</td>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $dte->receptor->direccion->complemento .
                                    ', ' .
                                    ExternalService::getCityNameByGoesId($dte->receptor->direccion->departamento, $dte->emisor->direccion->municipio) .
                                    ', ' .
                ...
                <td class="table-45">
                    <table class="table-100 indentification-info">
                        <thead>
                            <tr>
                                <td colspan="2" class="back-celest general-info">Sujeto de
                                    Retención</td>
                            </tr>
                        </thead>
                        <tbody>
        ...
        <table class="table-100 border-table table-info">
            <thead class="back-blue general-info">
                <tr>
                    ...
                    <td style="width: 18%">Tipo de doc relacionado</td>
                    <td style="width: 20%">Nº del Doc. relacionado</td>
                    <td style="width: 12%">Fecha del documento</td>
                    <td style="width: 32%">Descripción</td>
                    <td style="width: 8%;" class="text-number-right">Monto sujeto a retención</td>
                    <td style="width: 8%;" class="text-number-right">IVA retenido</td>
                </tr>
            </thead>
            <tbody>
                @foreach ($dte->cuerpoDocumento as $bodyItem)
                    <tr>
                        ...
                        <td>{{ ExternalService::getNameByGoesId('dte_types', $bodyItem->tipoDte) }}</td>
                        <td class="general-info">{{ $bodyItem->numDocumento }}</td>
                        <td class="general-info">{{ $bodyItem->fechaEmision }}</td>
                        <td class="general-info">{{ $bodyItem->descripcion }}</td>
                        <td class="text-number-right">${{ formatTwoDecimals($bodyItem->montoSujetoGrav) }}</td>
                        <td class="text-number-right">${{ formatTwoDecimals($bodyItem->ivaRetenido) }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
        ...
        <table class="table-100 border-table indentification-info">
            ...
            <tr>
                <td>
                    <table class="table-100">
                        <tr>
                            <td>Total IVA retenido en letras:</td>
                            <td>{{ $dte->resumen->totalIVAretenidoLetras }}</td>
                        </tr>
                    </table>
                </td>
                </td>
                ...
                <td>
                    <table class="table-100 border-table">
                        ...
                        <tbody>
                            <tr>
                                <td class="border-bottom-black">Total monto sujeto a retención</td>
                                <td class="text-number-right border-bottom-black">
                                    ${{ formatTwoDecimals($dte->resumen->totalSujetoRetencion) }}</td>
                            </tr>
                            <tr>
                                <td>Total IVA retenido</td>
                                <td class="text-number-right">${{ formatTwoDecimals($dte->resumen->totalIVAretenido) }}
                                </td>
                            </tr>
                        </tbody>
                    </table>
